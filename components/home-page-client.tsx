...
export default function HomePageClient() {
    ...
    return (
        <div className="min-h-screen bg-background">
                    ...
                    <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row pt-4">
                                <button
                                    ...
                                    className="flex h-12 items-center gap-2 rounded-lg bg-primary px-8 text-base font-medium text-primary-foreground transition hover:bg-primary/90"
                                >
                        ...
                        <div className="relative h-64 sm:h-80 lg:h-96 rounded-lg overflow-hidden bg-muted border border-border shadow-lg">
                            <div className="w-full h-full bg-gradient-to-br from-secondary/20 via-primary/10 to-primary/5 flex items-center justify-center">
                                <img src="/image/img1.png" alt="Study Abroad" className="h-auto sm:h-auto lg:h-auto object-contain" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="statistics" className="bg-secondary text-white px-4 py-12 sm:px-6 sm:py-16">
                <div className="mx-auto max-w-7xl">
            ...
            <section id="Destinations" className="px-4 py-12 sm:px-6 sm:py-16">
                <div className="mx-auto max-w-7xl">
                    ...
                    <Destination onAssessmentClick={() => setIsAssessmentOpen(true)} />
            ...
            <section id="Services" className="bg-muted/30 px-4 py-12 sm:px-6 sm:py-16">
                <div className="mx-auto max-w-7xl">
                    <div className="text-center mb-12">
            ...
            <section id="About" className="px-4 py-12 sm:px-6 sm:py-16">
                <div className="mx-auto max-w-7xl">
                    <div className="grid gap-12 lg:grid-cols-2 items-center">
                        ...
                        <div className="h-96 rounded-lg overflow-hidden bg-muted border border-border shadow-lg">
                            <div className="w-full h-full bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center">
                                <img src="/image/img2.png" alt="Mamun's Academy" className="h-auto sm:h-auto lg:h-auto object-contain" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="Testimonials" className="bg-muted/30 px-4 py-12 sm:px-6 sm:py-16">
                <div className="mx-auto max-w-7xl">
                    <div className="text-center mb-12">
            ...
            <section id="Contact" className="bg-gradient-to-r from-secondary to-primary px-4 py-12 sm:px-6 sm:py-16 text-white">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button
                            onClick={() => setIsAssessmentOpen(true)}
                            className="bg-white text-primary hover:bg-white/90 h-12 text-base px-8 font-semibold"
                        >
                            Free Assessment
                        </Button>
                        <a
            ...
            <section id="Newsletter" className="px-4 py-12 sm:px-6 sm:py-16">
                <div className="mx-auto max-w-3xl text-center">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4">Stay Updated</h2>
                    <p className="text-muted-foreground mb-8 text-lg">
                        Subscribe to our newsletter for the latest visa updates, scholarship opportunities, and study abroad tips.
                    </p>
                </div>

                <Subscriber isOpen={true} onClose={() => { }} />
            </section>
